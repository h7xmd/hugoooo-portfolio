...
const timelineItems = [{
  year: "2024",
  title: "Desenvolvedor Sênior de IA",
  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="glass-card rounded-3xl p-8">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Sou um desenvolvedor apaixonado que adora construir soluções inovadoras na interseção entre IA e tecnologias web. Com uma base sólida tanto em desenvolvimento frontend quanto backend, crio experiências digitais perfeitas.
              </p>
              <p>
        ...
        >
          <h3 className="text-xl font-semibold text-foreground mb-6">Linha do Tempo da Carreira</h3>
